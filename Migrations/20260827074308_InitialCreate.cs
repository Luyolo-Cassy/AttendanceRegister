        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CheckInCode = table.Column<string>(type: "TEXT", maxLength: 6, nullable: false),
                    CheckInOpensAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    CheckInClosesAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Lectures_AspNetUsers_CreatedByLecturerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecordedBy = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceRecords_LectureId_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Lectures_CheckInCode",
                table: "Lectures",
                column: "CheckInCode");

            migrationBuilder.CreateIndex(
                name: "IX_Lectures_CreatedByLecturerId",
                table: "Lectures",
